...
void v2SummaryPlots_y()
{
  ...
  double bkg_highPt_ptybins[nybins_highPt]         = {0.0633, 0.1587};
  double bkg_highPt_ptybins_err[nybins_highPt]     = {0.0308, 0.0316};
  ...
  double jpsiCorr_highPt_ptyfinebins[nyfinebins_highPt]      = {0.0702,
								0.0738,
								0.0799,
								0.0685,
								0.0590};
  ...
  // bkg
  double bkg_lowPt_ptybins[nybins_lowPt]           = {0.1100};
  double bkg_lowPt_ptybins_err[nybins_lowPt]       = {0.0107};

 // vtx10cm signal
  double jpsiVtx10_lowPt_ptybins[nybins_lowPt]           = {0.0874};
  double jpsiVtx10_lowPt_ptybins_err[nybins_lowPt]       = {0.0258};
  ...
  // triggers
  double jpsiL1NHitTrig_lowPt_ptybins[nybins_lowPt]      = {0.0980};
  ...
  pg_jpsi_highPt_ptybins->SetMarkerStyle(21);
  pg_jpsi_highPt_ptybins->SetMarkerSize(1.8);
  pg_jpsi_highPt_ptybins->SetMarkerColor(kRed+2);
  pg_jpsi_highPt_ptybins->Draw("PZ");
...
//       pg_bkg_highPt_ptybins->Draw("PZ");
  ...
  if(bAddVtx)
    {
      pg_jpsiVtx10_lowPt_ptybins->SetMarkerStyle(24);
  ...
  if(bAddNoFlat)
    {
      ...
      pg_jpsiCorr_highPt_ptyfinebins->SetMarkerStyle(25);
  ...
  if(bAddTrigger)
    {
      pg_jpsiL1NHitTrig_lowPt_ptybins->SetMarkerStyle(24);
      ...
      legTrig->AddEntry(pg_jpsi_lowPt_ptybins,"Default: all triggers","P");
      legTrig->AddEntry(pg_jpsiL1NHitTrig_lowPt_ptybins,"HLT_HIL1DoubleMu0_HighQ","P");
