...
void Plot_MCv2Summary_Sailor(){
    ...
    // Reco After Eff and resolution Correction
    double rACt0[] = {0.1686,0.1231,0.0760,0.2005};
    double rACtErr0[] = {0.0285,0.0230,0.0223,0.0237};
    double rAPt0[] = {0.0075,0.1461,0.3040};
    double rAPtErr0[] = {0.0253,0.0233,0.0261};

    double rARap0[] = {0.1629,0.1212,0.0991};
    double rARapErr0[] = {0.0225,0.0267,0.0236};
    double rARap1[] = {0.0694};
    double rARapErr1[] = {0.0382};


    // Reco After Eff with Cent Free and No Resolution Correction
    double rBCt0[] = {0.102,0.0965,0.0598,0.1287};
    double rBCtErr0[] = {0.0244,0.0255,0.0248,0.0215};
    double rBPt0[] = {0.0003,0.1081,0.2178};
    double rBPtErr0[] = {0.0257,0.0244,0.0265};

    double rBRap0[] = {0.1177,0.0796,0.0726};
    double rBRapErr0[] = {0.0230,0.0259,0.0243};
    double rBRap1[] = {0.0694};
    double rBRapErr1[] = {0.0382};

    // Reco after correction and No Res Corr
    double rCt0[] = {0.102,0.0965,0.0598,0.1287};
    double rCtErr0[] = {0.0244,0.0255,0.0248,0.0215};
    double rPt0[] = {0.0054,0.1054,0.2193};
    double rPtErr0[] = {0.0258,0.0238,0.0266};

    double rRap0[] = {0.1175,0.0874,0.0715};
    double rRapErr0[] = {0.0230,0.0272,0.0241};
    double rRap1[] = {0.0595};
    double rRapErr1[] = {0.0460};

    double gCt0[] = {0.1262, 0.1040, 0.0875, 0.1085};
    double gCtErr0[] = {0.0188, 0.0172, 0.0164, 0.0148};
    double gPt0[] = {0.0325, 0.0908, 0.2148};
    double gPtErr0[] = {0.0135, 0.0159, 0.0256};

    double gRap0[] = {0.1149, 0.0810, 0.0982};
    double gRapErr0[] = {0.0165, 0.0170, 0.0169};
    double gRap1[] = {0.0459};
    double gRapErr1[] = {0.0170};
    ...
    gBarrCent2->SetMarkerStyle(29);
    gBarrCent0->SetMarkerColor(kBlue+2);
    gBarrCent1->SetMarkerColor(kRed+2);
    gBarrCent2->SetMarkerColor(kGreen+2);
    gBarrCent0->SetMarkerSize(1.8);
    gBarrCent1->SetMarkerSize(1.8);
    gBarrCent2->SetMarkerSize(2.2);
    */
    ...
    lt1->DrawLatex(0.68,0.82,"Sailor");
    ...
    c1->SaveAs("MCv2_Cents_0420_sailor.png");
    c1->SaveAs("MCv2_Cents_0420_sailor.pdf");
    ...
    c1->SaveAs("MCv2_Pts_0420_sailor.png");
    c1->SaveAs("MCv2_Pts_0420_sailor.pdf");
    ...
    c1->SaveAs("MCv2_Raps_0420_sailor.png");
    c1->SaveAs("MCv2_Raps_0420_sailor.pdf");
