...
void MCCTPtDep()   
{
  for(int iSpec = 0; iSpec < 3; iSpec++){
    ...
    // iCat : decide the categories for pT (1: 6.5 - 8.0, 2: 8.0 - 10.0, 3: 10.0 - 40.0 GeV/c)
    for(int iCat = 1; iCat < 4; iCat++){
      ...
      if(iCat == 0) sprintf(OutTextFile,"MCCT_PrJpsi_Pts_030065_dPhi_%s.tex", cCond);
      if(iCat == 1) sprintf(OutTextFile,"MCCT_PrJpsi_Pts_065080_dPhi_%s.tex", cCond);
      if(iCat == 2) sprintf(OutTextFile,"MCCT_PrJpsi_Pts_080100_dPhi_%s.tex", cCond);
      if(iCat == 3) sprintf(OutTextFile,"MCCT_PrJpsi_Pts_100400_dPhi_%s.tex", cCond);
      ...
      for (int ifile = 0; ifile < nFiles; ifile++) {
        for (Int_t idphi = 0; idphi < ndPhiBins; idphi++) {
          ...
          diMuonsInvMass_GenA[ifile][idphi]= new TH1D(nameGen[ifile],nameGen[ifile],  100,2.9,3.1); //for eff Gen;
          ...
          diMuonsInvMass_RecA[ifile][idphi] = new TH1D(nameRec[ifile],nameRec[ifile], 100,2.9,3.1); //for eff Rec;
        ...
        for(int i=0; i< nGenEntries; i++)  {        
          ...
          for (Int_t idphi = 0; idphi < ndPhiBins; idphi++) {
            ...
            //adding pT of all pt bins to see diss is cont
              ...
              if(iCat == 0)  {
                if( AccJpsi == 1 && (gbin >= 4 && gbin < 24) && (GenPosIn==1 && GenNegIn==1) && (GenJpsiPt >= 3.0 && GenJpsiPt < 6.5) &&  
              ...
              if(iCat == 1)  {
                if( AccJpsi == 1 &&  (gbin >= 4 && gbin < 24) && (GenPosIn==1 && GenNegIn==1) && (GenJpsiPt >= 6.5 && GenJpsiPt < 8.0) &&  
                    (TMath::Abs(GenJpsiRap)<2.4 && TMath::Abs(GenJpsiRap) >= 0.0 ) && 
                    (TMath::Abs(GenJpsiPsi)>=dphi_bound[idphi] && TMath::Abs(GenJpsiPsi)<dphi_bound[idphi+1])){diMuonsInvMass_GenA[ifile][idphi]->Fill(GenJpsiMass,GenWeight);}
              }
              if(iCat == 2)  {
                if( AccJpsi == 1 &&  (gbin >= 4 && gbin < 24) && (GenPosIn==1 && GenNegIn==1) && (GenJpsiPt >= 8.0 && GenJpsiPt < 10.0) &&  
                    (TMath::Abs(GenJpsiRap)<2.4 && TMath::Abs(GenJpsiRap) >= 0.0 ) && 
                    (TMath::Abs(GenJpsiPsi)>=dphi_bound[idphi] && TMath::Abs(GenJpsiPsi)<dphi_bound[idphi+1])){diMuonsInvMass_GenA[ifile][idphi]->Fill(GenJpsiMass,GenWeight);}
              }
              if(iCat == 3)  {
                if( AccJpsi == 1 &&  (gbin >= 4 && gbin < 24) && (GenPosIn==1 && GenNegIn==1) && (GenJpsiPt >= 10.0 && GenJpsiPt < 40.0) &&  
                    (TMath::Abs(GenJpsiRap)<2.4 && TMath::Abs(GenJpsiRap) >= 0.0 ) && 
                    (TMath::Abs(GenJpsiPsi)>=dphi_bound[idphi] && TMath::Abs(GenJpsiPsi)<dphi_bound[idphi+1])){diMuonsInvMass_GenA[ifile][idphi]->Fill(GenJpsiMass,GenWeight);}
              }
          }
        ...
        for(int i=0; i<nRecEntries; i++)  {     
          ...
          for (Int_t idphi = 0; idphi < ndPhiBins; idphi++) {
            if((JpsiCharge == 0) && (JpsiVprob > 0.01)) {     
              ...
              if(iCat == 0) {
                if( AccJpsi == 1 && (AllCut==1) && (rbin >= 4 && rbin < 24) && (JpsiPt>=3.0 && JpsiPt<6.5) && 
              ...
              if(iCat == 1) {
                if( AccJpsi == 1 && (AllCut==1) && (rbin >= 4 && rbin < 24) && (JpsiPt>=6.5 && JpsiPt<8.0) && 
                    (TMath::Abs(JpsiRap) < 2.4 && TMath::Abs(JpsiRap) >= 0.0) && 
                    (TMath::Abs(JpsiGenPsi) > dphi_bound[idphi] && TMath::Abs(JpsiGenPsi) <=dphi_bound[idphi+1])){
                  DoEffCor3D(eff_input, iCond, rbin, JpsiPt, fabs(JpsiRap), eff_cor);
                  diMuonsInvMass_RecA[ifile][idphi]->Fill(JpsiMass,RecWeight*((double)1.0/eff_cor[0]));}
              ...
              if(iCat == 2) {
                if( AccJpsi == 1 && (AllCut==1) && (rbin >= 4 && rbin < 24) && (JpsiPt>=8.0 && JpsiPt<10.0) && 
                    (TMath::Abs(JpsiRap) < 2.4 && TMath::Abs(JpsiRap) >= 0.0) && 
                    (TMath::Abs(JpsiGenPsi) > dphi_bound[idphi] && TMath::Abs(JpsiGenPsi) <=dphi_bound[idphi+1])){
                  DoEffCor3D(eff_input, iCond, rbin, JpsiPt, fabs(JpsiRap), eff_cor);
                  diMuonsInvMass_RecA[ifile][idphi]->Fill(JpsiMass,RecWeight*((double)1.0/eff_cor[0]));}
              ...
              if(iCat == 3) {
                if( AccJpsi == 1 && (AllCut==1) && (rbin >= 4 && rbin < 24) && (JpsiPt>=10.0 && JpsiPt<40.0) &&
                  (TMath::Abs(JpsiRap) < 2.4 && TMath::Abs(JpsiRap) >= 0.0) && 
                  (TMath::Abs(JpsiGenPsi) > dphi_bound[idphi] && TMath::Abs(JpsiGenPsi) <=dphi_bound[idphi+1])){
                  DoEffCor3D(eff_input, iCond, rbin, JpsiPt, fabs(JpsiRap), eff_cor);
                  diMuonsInvMass_RecA[ifile][idphi]->Fill(JpsiMass,RecWeight*((double)1.0/eff_cor[0]));}
      ...
      TFile *outfile;
      char tmp_output[512];
      if(iCat == 0) sprintf(tmp_output,"MCCT_PrJpsi_Pts_030065_dPhi_%s.root",cCond);
      if(iCat == 1) sprintf(tmp_output,"MCCT_PrJpsi_Pts_065080_dPhi_%s.root",cCond);
      if(iCat == 2) sprintf(tmp_output,"MCCT_PrJpsi_Pts_080100_dPhi_%s.root",cCond);
      if(iCat == 3) sprintf(tmp_output,"MCCT_PrJpsi_Pts_100400_dPhi_%s.root",cCond);
