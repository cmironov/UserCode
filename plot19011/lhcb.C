...
//=========  (Thu Jan 24 13:55:07 2019) by ROOT version5.34/21
  gROOT->ProcessLine(".x ~/lhcbStyle.C");
   ...
   grae->SetPoint(1,1.52564,0.106138);
   grae->SetPointError(1,0.52564,0.47436,0.0108716,0.0108716);
   grae->SetPoint(2,2.49043,0.1299313);
   grae->SetPointError(2,0.49043,0.50957,0.009931127,0.009931127);
   grae->SetPoint(3,3.47566,0.1124682);
   grae->SetPointError(3,0.47566,0.52434,0.007490612,0.007490612);
   grae->SetPoint(4,4.46905,0.1255385);
   grae->SetPointError(4,0.46905,0.53095,0.007318099,0.007318099);
   grae->SetPoint(5,5.46614,0.1253362);
   grae->SetPointError(5,0.46614,0.53386,0.007072173,0.007072173);
   grae->SetPoint(6,6.46552,0.1215612);
   grae->SetPointError(6,0.46552,0.53448,0.006293812,0.006293812);
   grae->SetPoint(7,7.46332,0.1246954);
   grae->SetPointError(7,0.46332,0.53668,0.006395943,0.006395943);
   grae->SetPoint(8,8.46456,0.1160136);
   grae->SetPointError(8,0.46456,0.53544,0.00589817,0.00589817);
   grae->SetPoint(9,9.46392,0.1203046);
   grae->SetPointError(9,0.46392,0.53608,0.006234959,0.006234959);
   grae->SetPoint(10,10.469,0.1206547);
   grae->SetPointError(10,0.469,0.531,0.006439252,0.006439252);
   grae->SetPoint(11,11.4659,0.1156761);
   grae->SetPointError(11,0.4659,0.5341,0.006263492,0.006263492);
   grae->SetPoint(12,12.4685,0.1154433);
   grae->SetPointError(12,0.4685,0.5315,0.006466278,0.006466278);
   grae->SetPoint(13,13.474,0.1224707);
   grae->SetPointError(13,0.474,0.526,0.007217828,0.007217828);
   grae->SetPoint(14,14.9015,0.1125218);
   grae->SetPointError(14,0.9015,1.0985,0.006137141,0.006137141);
   grae->SetPoint(15,16.9089,0.1074532);
   grae->SetPointError(15,0.9089,1.0911,0.006478771,0.006478771);
   grae->SetPoint(16,18.9352,0.1153543);
   grae->SetPointError(16,0.9352,1.0648,0.00792857,0.00792857);
   grae->SetPoint(17,22.114,0.1107342);
   grae->SetPointError(17,2.114,2.886,0.00728243,0.00728243);
   ...
   grae->SetPointError(0,0.657532,0.342468,0,0);
   grae->SetPoint(1,1.52564,0.106138);
   grae->SetPointError(1,0.52564,0.47436,0.009817442,0.009817442);
   grae->SetPoint(2,2.49043,0.1299313);
   grae->SetPointError(2,0.49043,0.50957,0.008120557,0.008120557);
   grae->SetPoint(3,3.47566,0.1124682);
   grae->SetPointError(3,0.47566,0.52434,0.005623221,0.005623221);
   grae->SetPoint(4,4.46905,0.1255385);
   grae->SetPointError(4,0.46905,0.53095,0.004800354,0.004800354);
   grae->SetPoint(5,5.46614,0.1253362);
   grae->SetPointError(5,0.46614,0.53386,0.004427495,0.004427495);
   grae->SetPoint(6,6.46552,0.1215612);
   grae->SetPointError(6,0.46552,0.53448,0.00331716,0.00331716);
   grae->SetPoint(7,7.46332,0.1246954);
   grae->SetPointError(7,0.46332,0.53668,0.003287148,0.003287148);
   grae->SetPoint(8,8.46456,0.1160136);
   grae->SetPointError(8,0.46456,0.53544,0.002954909,0.002954909);
   grae->SetPoint(9,9.46392,0.1203046);
   grae->SetPointError(9,0.46392,0.53608,0.003294632,0.003294632);
   grae->SetPoint(10,10.469,0.1206547);
   grae->SetPointError(10,0.469,0.531,0.003644248,0.003644248);
   grae->SetPoint(11,11.4659,0.1156761);
   grae->SetPointError(11,0.4659,0.5341,0.003650452,0.003650452);
   grae->SetPoint(12,12.4685,0.1154433);
   grae->SetPointError(12,0.4685,0.5315,0.004001424,0.004001424);
   grae->SetPoint(13,13.474,0.1224707);
   grae->SetPointError(13,0.474,0.526,0.00480196,0.00480196);
   grae->SetPoint(14,14.9015,0.1125218);
   grae->SetPointError(14,0.9015,1.0985,0.003626636,0.003626636);
   grae->SetPoint(15,16.9089,0.1074532);
   grae->SetPointError(15,0.9089,1.0911,0.004429564,0.004429564);
   grae->SetPoint(16,18.9352,0.1153543);
   grae->SetPointError(16,0.9352,1.0648,0.006091027,0.006091027);
   grae->SetPoint(17,22.114,0.1107342);
   grae->SetPointError(17,2.114,2.886,0.005412433,0.005412433);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,1.9,27.1);
   Graph_Graph1->SetMinimum(0);
   Graph_Graph1->SetMaximum(0.1378668);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   Graph_Graph1->SetLineWidth(2);
   Graph_Graph1->SetMarkerStyle(20);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,1.9,27.1);
   Graph_Graph2->SetMinimum(0);
   Graph_Graph2->SetMaximum(0.1426851);
   Graph_Graph2->SetDirectory(0);
   Graph_Graph2->SetStats(0);
   Graph_Graph2->SetLineWidth(2);
   Graph_Graph2->SetMarkerStyle(20);
   ...
   ffit->SetParameter(0,0.1186723);
   ffit->SetParError(0,0);
   ffit->SetParLimits(0,0,0);
   ffit->SetParameter(1,-0.0009081832);
