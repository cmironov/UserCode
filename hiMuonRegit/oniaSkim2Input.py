...
process.source.fileNames          = cms.untracked.vstring("file:/tmp/camelia/regitTest_rd.root")
process.source.secondaryFileNames = cms.untracked.vstring("file:/tmp/camelia/8A5E77D3-5421-E111-A72F-485B3977172C.root")
...
process.outOnia2MuMu.fileName = cms.untracked.string( '/tmp/camelia/onia2MuMuPAT_RD_regit.root' )
